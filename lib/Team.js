...
const theHtml = require('./utils/pageTemplate');
const { writeFile, copyFile } = require('./utils/write');
...
//ask manager question, make new team member object, add that object card to html, add object to team roster in object, call the loop
...
//ask engineer question, make new team member object, add that object card to html, add object to team roster in object, call the loop
...
//ask intern question, make new team member object, add that object card to html, add object to team roster in object, call the loop
...
//write the html to page
    publish() {
        let thisPage = theHtml(this.projectTitle, this.teamRoster);
        writeFile(this.projectTitle, thisPage);
        copyFile(this.projectTitle);
        console.log('The file is complete, with the following information: ', this.teamName);
        for (let i = 1; i < this.teamRoster.length; i++) {
