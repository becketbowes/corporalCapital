...
function Manager(employeename, title, idType, email, phone, extra) {
...
Manager.prototype.makeManager = function (title, idType) {
    managerQ = [
        {
            type: 'text',
            name: 'employeename',
    ...
    inquirer
        ...
        .then((data) => {
            ...
            if (kind === "No, thats everyone. I'm ready to publish the site") {
                ...
                this.manager = new Manager.prototype.makeManager(kind, idType);
...
module.exports = Manager.prototype.makeManager;